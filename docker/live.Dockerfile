...
COPY --from=codegolf/lang-assembly   ["/", "/langs/assembly/rootfs/"  ] # 48.8 MiB
COPY --from=codegolf/lang-v          ["/", "/langs/v/rootfs/"         ] # 35.1 MiB
...
COPY --from=codegolf/lang-javascript ["/", "/langs/javascript/rootfs/"] # 20.6 MiB
